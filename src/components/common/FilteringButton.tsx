    ...
    return (
        <div className='flex gap-6px px-[20px]'>
            ...
            <button
                ...
                className='w-sm px-8px flex justify-center items-center text-sm text-white font-semibold bg-gradient-to-r from-secondary to-primary rounded-2xl transition duration-150 ease-in-out hover:text-white'
            >
                실시간 순
            </button>
            <button
            ...
            >
                <div className='w-sm p-4px bg-white rounded-2xl'>
                    <span className='px-2px bg-clip-text bg-gradient-to-r from-secondary to-primary'>
                        좋아요 순
                    </span>
                </div>
            </button>
