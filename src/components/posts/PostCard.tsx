...
export default function PostCard({ imageUrl = '/src/assets/images/a.jpg', userId = '호랑이', reviewDate, theme = '관광명소', content = '예쁜 공원에서 책도 읽고 낮잠잤어요!굳이데이 덕분에 좋은 시간 보냅니당' }: PostCardProps) {
    const [isLiked, setIsLiked] = useState(false);
    const date = reviewDate.toDate
    ...
    return (
        <div className='flex flex-col w-[167px] h-[270px] text-ellipsis overflow-hidden'>
            ...
            <div className='flex justify-between p-2px pt-4px'>
                ...
                <span className='font-light text-sm flex items-center tracking-tight'>{date.toString()}</span>
            </div>
